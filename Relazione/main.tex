...
\includegraphics[width=1\linewidth]{NFLXonMETA.png} 
\caption{NFLX e META correlation}
\label{fig:subim1}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=1\linewidth]{GSonC.png}
\caption{GS e C correlation}
\label{fig:subim2}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=1\linewidth]{KOonPEP.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth, center]{NFLXsvm.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth, center]{METAsvm.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth, center]{GSsvm.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth, center]{Csvm.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth, center]{KOsvm.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth, center]{PEPsvm.png}
...
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=1\linewidth]{pReturnTearSheet.jpeg}
\caption{Max past returns}
\label{fig:subim4}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=1\linewidth]{eReturnTearSheet.jpeg}
